import { createProjectSchema, ICreateProjectSchema } from "@/app/workspace/project/validation"
...
interface ProjectFormProps {
  schema: typeof createProjectSchema;
  defaultValues: ICreateProjectSchema;
  onSubmit: (values: ICreateProjectSchema) => void;
  isLoading?: boolean;
}
...
export function CreateProject({defaultValues, isLoading, onSubmit, schema}: ProjectFormProps) {
  ...
  const handleSubmit = async (values: ICreateProjectSchema) => {
    onSubmit(values);
  };
